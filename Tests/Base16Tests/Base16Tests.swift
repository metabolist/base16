...
final class Base16Tests: XCTestCase {
    ...
    static var allTests = [
        ("testLowercaseString", testLowercaseString),
        ("testUppercaseString", testUppercaseString),
        ("testLowercaseData", testLowercaseData),
        ("testUppercaseData", testUppercaseData),
        ("testInitializationFromLowercaseString", testInitializationFromLowercaseString),
        ("testInitializationFromUppercaseString", testInitializationFromUppercaseString),
        ("testInitializationFromLowercaseData", testInitializationFromLowercaseData),
        ("testInitializationFromUppercaseData", testInitializationFromUppercaseData),
        ("testInvalidLength", testInvalidLength),
        ("testInvalidByteString", testInvalidByteString),
        ("testInvalidStringEncoding", testInvalidStringEncoding)
    ]
}
